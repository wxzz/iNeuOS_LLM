...
├───datasets.json/  //微调训练模型的输入数据集文件<br>
├───merged_model.py/  //用于合并基础模型与微调后的模型<br>
├───test_base_model.py/  //测试基础模型<br>
├───test_merged_model.py/  //测试合并后的模型<br>
├───test_train_model.py/  //测试微调后的模型<br>
├───train_model.py/  //微调训练模型<br>
├───training_dataset.json/  //转换Word生成的数据集文件<br>
